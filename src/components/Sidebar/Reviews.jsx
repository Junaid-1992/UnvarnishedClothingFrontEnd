...
import sen from "../../assets/Images/sezancard.png";
import sen1 from "../../assets/Images/sen2.png";
import { Link, useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getuserReviews } from "../../Redux/Features/addreviewSlice";
const Reviews = ()=>{
...
useEffect(()=>{
  ...
  dispatch(getuserReviews(email))

},[])

const Reviews= useSelector((state)=>state.addreview.userReviews)
...
const handleNavigate=(id)=>{
  ...
  navigate(`single-review-details/${id}`)
...
{/* <section class="sec1"> */}
        <div class="main-1">
            <h1 class="h1-1">My Reviews</h1>
           <div class="Re-Card-box">

            {
              Reviews?.map((e,i)=>(


            <div class="Re-card" key={i} onClick={()=>handleNavigate(e._id)}>
              <div class="re-card-sec-1">
                <img width="100%"  src={e?.pictures[0]} alt=""/>
              </div>
              <div class="re-card-sec-2">
              <div class="re-sec-2-1">
                <p class="re-date">AUG 2024</p>
              </div>
              <div class="re-sec-2-2">
                <h4>{e?.brand}</h4>
                <h5>{e?.productName}</h5>
                <p>{e?.color}, {e?.size}</p>
              </div>
              <div class="re-sec-2-3">
              <Link   className="none-list">
