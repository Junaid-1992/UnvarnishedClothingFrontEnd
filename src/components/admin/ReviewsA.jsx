...
import { deleteReview, getAllReviews, getreviews } from "../../Redux/Features/addreviewSlice";
...
const ReviewsA=()=>{
  ...
  const navigate = useNavigate()
      const handleNavigate=(id)=>{
        ...
        navigate(`admin-single-review-details/${id}`)
    ...
    <tbody>
...

      {
        reviews.map((e,i)=>(
          ...
          <td className="heil"> <img src={e?.pictures[0]} alt=""  style={{width:"50px",height:"50px"}}/></td>
