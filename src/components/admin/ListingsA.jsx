...
import { deleteListing, getalllistings } from "../../Redux/Features/addListingSlice";
...
const ListingsA=()=>{
  ...
  const navigate = useNavigate()
      const handleNavigate=(id)=>{
        ...
        navigate(`admin-single-product-listing/${id}`)
  ...
  const Listings= useSelector((state)=>state.addlisting.AllListings)
  useEffect(()=>{
        ...
        <defs>
          <clipPath id="clip0_549_1383">
            <rect width="19" height="19" fill="white"/>
                      ...
                      <img src={delet} alt=""  onClick={()=>delete_listing(e._id)}/>
                  </td>
